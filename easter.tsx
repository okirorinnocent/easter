...
# Replace the URL in 'src' below with your actual image path or URL
            ...
            <head>
                <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                        <title>Easter Greeting - Okiror Innocent</title>
                        <!-- Tailwind for styling, React for logic, and Framer Motion for animations -->
                ...
                [0, 1].map((j) => (
                    ...
                    <div className="relative min-h-screen overflow-hidden bg-white">
                        <div className="absolute inset-0">
                            <img src="{BACKGROUND_IMAGE_URL}" alt="" className="w-full h-full object-cover opacity-40" />
